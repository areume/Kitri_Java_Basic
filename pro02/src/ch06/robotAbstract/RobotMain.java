 ...
 * @date   : 2020. 5. 8.
 * @description : 시나리오
 * 				  1) 로봇 모양은 팔, 다리, 머리, 몸통으로 구성되어 있다.
 * 				  2) 로봇은 기본적으로 걷고, 달릴 수 있다.
 * 				  3) 로봇 종류에 따라서 날 수 있고, 미사일 쏠 수 있고, 검을 가질 수 있다.
 * 
 * 				  4) super 로봇은 날 수 있고, 미사일 쏠 수 있고, 레이저 검을 가지고 있다.
 * 				  5) standard 날 수는 없고, 로봇은 미사일 쏠 수 있고, 목검을 가지고 있다.
 * 				  6) low 로봇은 날 수도 없고, 미사일을 쏠 수 없고, 검도 없다.
 */
